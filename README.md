...
Требуется написать тесты веб приложение создать  Pull request в этот репозиторий.
...
Возврощает предложение "Вернемся через <count> минут/минуты/минуту, в зависимости от числа.
